                ...
                <div class="content">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <p class="mb-5">Alerts provide contextual feedback messages for typical user actions
                                        with the handful of available and flexible alert messages. Read bootstrap
                                        documentaion for <a href="https://getbootstrap.com/docs/4.4/components/alerts/"
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <p class="mb-5"> For icon alert add <code> &lt;i class="mdi mdi-alert
                                            mr-1"&gt;&lt;/i&gt; </code> inside <code> &lt; div class="alert"
                                            role="alert"&gt; </code>. Get classes for material icon <a
                                            href="material-icon.html">here</a>.
                                    </p>
                                </div>
                                <div class="col-lg-6">
                                    <label for="primary">primary alerts</label>
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <p class="mb-5">Alerts are available for any length of text, as well as an optional
                                        dismiss button. For proper
                                        styling, use one of the eight required contextual classes (e.g.,
                                        <code>.alert-success</code> ).
                                        For inline dismissal, use the <a
                                            href="https://getbootstrap.com/docs/4.4/components/alerts/#dismissing"
                                            target="_blank">alerts jQuery plugin.</a></p>
                                </div>
                                <div class="col-lg-6">
                                    <label for="primary">primary alerts</label>
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <p class="mb-5"> For Heightlighted Alert add class <code> .alert-highlighted </code>
                                        to <code> &lt;div class="alert" role="alert"&gt; </code>
                                    </p>
                                </div>
                                <div class="col-lg-6">
                                    <label for="primary">primary alerts</label>
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <p class="mb-5"> For outline Alert add class <code> .alert-outlined </code> to
                                        <code> &lt; div class="alert" role="alert"&gt; </code>
                                    </p>
                                </div>
                                <div class="col-lg-6">
                                    <label for="primary">primary alerts</label>
                                    <div class="alert alert-primary alert-outlined alert-dismissible fade show"
                                        role="alert">
                                        This is a primary alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                    ...
                                    <label for="secondary">secondary alerts</label>
                                    <div class="alert alert-secondary alert-outlined alert-dismissible fade show"
                                        role="alert">
                                        This is a secondary alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                    ...
                                    <label for="success">success alerts</label>
                                    <div class="alert alert-success alert-outlined alert-dismissible fade show"
                                        role="alert">
                                        This is a success alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                    ...
                                    <label for="danger">danger alerts</label>
                                    <div class="alert alert-danger alert-outlined alert-dismissible fade show"
                                        role="alert">
                                        This is a danger alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                ...
                                <div class="col-lg-6">
                                    <label for="warning">warning alerts</label>
                                    <div class="alert alert-warning alert-outlined alert-dismissible fade show"
                                        role="alert">
                                        This is a warning alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                    ...
                                    <label for="info">info alerts</label>
                                    <div class="alert alert-info alert-outlined alert-dismissible fade show"
                                        role="alert">
                                        This is a info alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                    ...
                                    <label for="light">light alerts</label>
                                    <div class="alert alert-light alert-outlined alert-dismissible fade show"
                                        role="alert">
                                        This is a light alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                    ...
                                    <label for="dark">dark alerts</label>
                                    <div class="alert alert-dark alert-outlined alert-dismissible fade show"
                                        role="alert">
                                        This is a dark alert—check it out!
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
